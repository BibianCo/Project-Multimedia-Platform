...
public class AdministratorControllerTest {
        ...
        public void updateChapter() {
                administrator.addChapter("Prueba1", 1, 100, "Chapter Desciption 1", "Chapter prueba 1");
                administrator.updateChapter("Prueba1", 1, "Chapter prueba 1", 333, "Hola que hace", "A todo gas");
                assertEquals("[Multimedia [title=Prueba1, description=Description1, category=Category1, publication=2020-12-12, reproduce=false]Serie [numberSeasons=1, seasons=[Season [numberOfChapters=[Chapter [duration=333, description=Hola que hace, title=A todo gas]], description=SeasonDescription, publicationSeason=1010-10-10, numberSeason=1]]]]",
                                administrator.showSeries());

                administrator.addChapter("Prueba1", 1, 100, "Chapter Desciption 2", "Chapter prueba 2");
                administrator.updateChapter("Prueba1", 1, "Chapter prueba 2", 444, "No hago na", "A todo gas 2.0");
                assertEquals("[Multimedia [title=Prueba1, description=Description1, category=Category1, publication=2020-12-12, reproduce=false]Serie [numberSeasons=1, seasons=[Season [numberOfChapters=[Chapter [duration=333, description=Hola que hace, title=A todo gas], Chapter [duration=444, description=No hago na, title=A todo gas 2.0]], description=SeasonDescription, publicationSeason=1010-10-10, numberSeason=1]]]]",
                                administrator.showSeries());
        }
